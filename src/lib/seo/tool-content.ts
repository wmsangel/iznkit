...
const rentalYield: Content = {
  ...
  ru: {
    ...
    metaExtra:
      "Посчитайте доходность квартиры под сдачу онлайн: валовая и чистая доходность, окупаемость в годах, денежный поток с ипотекой. Бесплатно, без регистрации, PDF-отчёт.",
  },
};
...
const hourly: Content = {
  ...
  ru: {
    ...
    metaExtra:
      "Сколько брать за час фрилансеру? Посчитайте ставку онлайн от желаемого дохода «на руки»: с учётом налога, расходов и неоплачиваемых часов. Бесплатно, без регистрации, PDF.",
  },
};
